...
def run_test_largest_number():
    ...
    # Done (continued): Add your ADDITIONAL test(s) here:
    # Test 4:
    expected = 123
    answer = largest_number(([12], [-12], [123]))
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    largestnumber=-99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
    for k in range(len(seq_seq)):
        for j in range(len(seq_seq[k])):
            if seq_seq[k][j]>largestnumber:
                largestnumber=seq_seq[k][j]
    if largestnumber==-99999999999999999999999999999999999999999999999999999999999999999999999999999999999999999:
        return None
...
def run_test_largest_negative_number():
    ...
    # Test 4:
    expected = -12
    answer = largest_negative_number(([12], [-12], [123]))
    print('Expected and actual are:', expected, answer)
...
def largest_negative_number(seq_seq):
    ...
    for k in range(len(seq_seq)):
        for j in range(len(seq_seq[k])):
            if seq_seq[k][j]<0:
                if seq_seq[k][j] < largestnegative:
                    largestnegative = seq_seq[k][j]
